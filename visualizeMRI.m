...
sliceSlider = uislider(fig, 'Limits', [0 154], 'Position', [50 420 700 3], 'Value', 1); % Change here
sliceSliderLabel = uilabel(fig, 'Text', 'Slice:', 'Position', [50 415 50 15]);
channelDropdownLabel = uilabel(fig, 'Text', 'Channel:', 'Position', [250 415 60 15]);
annotationDropdownLabel = uilabel(fig, 'Text', 'Annotation:', 'Position', [400 415 80 15]);
